/* feddemo - test of federation algorithm
   ...
   g++ -g -O0 -Wall -Wextra -std=c++0x -pedantic-errors -Wno-empty-body \
   ...
   these compile options have also been used:
   g++ -DYYTEXT_POINTER=1 -fPIC -W -Wnon-virtual-dtor -ansi -std=c++98 -pipe
 */
