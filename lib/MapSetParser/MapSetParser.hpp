...
/* Line 35 of lalr1.cc  */
#line 380 "lib/MapSetParser/MapSetParser.hpp"
    };
#else
   ...
   enum yytokentype {
     ...
     DECIMAL = 405,
     DOUBLE = 406,
     INTEGER_POSITIVE = 407,
     DECIMAL_POSITIVE = 408,
     DOUBLE_POSITIVE = 409,
     INTEGER_NEGATIVE = 410,
     DECIMAL_NEGATIVE = 411,
     DOUBLE_NEGATIVE = 412,
     STRING_LITERAL1 = 413,
     STRING_LITERAL_LONG1 = 414,
     STRING_LITERAL2 = 415,
     STRING_LITERAL_LONG2 = 416,
     IRI_REF = 417,
     PNAME_NS = 418,
     PNAME_LN = 419,
...
/* Line 35 of lalr1.cc  */
#line 737 "lib/MapSetParser/MapSetParser.hpp"
