...
#line 361 "lib/SPARQLfedParser/SPARQLfedParser.hpp"
   ...
   enum yytokentype {
     ...
     IT_RAND = 373,
     IT_SHA512 = 374,
     GT_DELETE_LBRACKET_SPACECHAR_TAB_RETURN_LINEFEED_RBRACKET_PLUS_WHERE = 375,
     IT_NOW = 376,
     GT_DELETE_LBRACKET_SPACECHAR_TAB_RETURN_LINEFEED_RBRACKET_PLUS_DATA = 377,
     IT_TZ = 378,
     IT_TIMEZONE = 379,
     IT_ROUND = 380,
     IT_SHA384 = 381,
     ...
     IT_MOVE = 385,
     IT_FLOOR = 386,
     GT_INSERT_LBRACKET_SPACECHAR_TAB_RETURN_LINEFEED_RBRACKET_PLUS_DATA = 387,
     IT_MINUTES = 388,
     IT_SUBSTR = 389,
     IT_SHA256 = 390,
     IT_HOURS = 391,
