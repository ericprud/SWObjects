SELECT _all_0_entry.patient_num AS pat, _all_0_entry.start_date AS encDate, CONCAT("http://informatics.kumc.edu/404/i2b2demo/testtype#T", _all_0_concept.concept_cd) AS t
