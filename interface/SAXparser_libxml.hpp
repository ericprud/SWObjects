...
namespace w3c_sw {
	...
	public:
	    ...
	    virtual std::string getQName (size_t i) const { if (!initialized) const_cast<Attributes_libxml*>(this)->init(); return SWSAXhandler::qName(byIndex[i].prefix, byIndex[i].localName); }
